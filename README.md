...
API documentation plugin for [Manic](https://github.com/Rahuletto/manic). Mounts a [Scalar](https://scalar.com) API reference UI at `/docs`, powered by the auto-generated `/openapi.json` spec.
